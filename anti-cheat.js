...
console.log("ANTI CHEAT STARTED");
	...
	function sendViolationLog(reason){
...
window.addEventListener(
    ...
    function(){
        ...
        blurTimeout = setTimeout(function(){
            ...
            if(!windowFocused){
                ...
                addViolation(
                    "Fokus keluar dari halaman ujian"
                );
	...
	window.addEventListener(
		...
		function(){
			...
			// Hanya tampilkan overlay
			focusOverlay.style.display =
				"block";

			// Optional warning ringan
			showToast(
				"⚠️ Fokus browser berpindah",
				"#ef6c00"
			);
	...
	document.addEventListener(
		...
		function(e){
			...
			if(
				...
				showToast(
					"⚠️ Cursor keluar dari halaman ujian",
					"#546e7a"
				);
